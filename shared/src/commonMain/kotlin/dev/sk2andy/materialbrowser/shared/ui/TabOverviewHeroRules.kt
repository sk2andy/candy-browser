...
object TabOverviewHeroRules {
    const val ENTRY_DURATION_MILLIS = 160
    const val EXIT_DURATION_MILLIS = 200
    ...
    fun titleAlpha(entryProgress: Float): Float =
        ((entryProgress - TITLE_ENTRY_START) / (1f - TITLE_ENTRY_START))
            .coerceIn(0f, 1f)
    ...
    private const val TITLE_ENTRY_START = 0.72f
